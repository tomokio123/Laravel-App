                  ...
                  <div class="-m-2">
                    ...
                    <div class="p-2 w-1/2 mx-auto">
                      <div class="relative">
                        ...
                        {{--バリデーションをかけないなら「name="image[]"」だけでも良いが、Laravelのバリデーションをかけるなら、「name="files[][image]"」とせよ
                        これはApp\Http\Requests\UploadImageRequest;の中のrules()メソッドと揃えることでバリデーションとして成功する

                        また、multipleプロパティを宣言しておくことで、複数同時アップロードができるようになる--}}
