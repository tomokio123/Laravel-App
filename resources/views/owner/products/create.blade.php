                    ...
                    <div class="-m-2">
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative">
                          ...
                          <input type="text" id="name" name="name" value="{{ old("name") }}" required class="w-full bg-white-500 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        </div>
                      </div>
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative">
                      ...
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative">
                          ...
                          <input type="number" id="price" name="price" value="{{ old('price') }}" required class="w-full bg-white-500 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        </div>
                      </div>
                      {{--表示順--}}
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative">
                          ...
                          <input type="number" id="sort_order" name="sort_order" value="{{ old('sort_order') }}" class="w-full bg-white-500 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        </div>
                      </div>
                      {{--初期在庫--}}
                      <div class="p-2 w-1/2 mx-auto">
                     ...
                     {{--Shop id--}}
                      ...
                      <div class="p-2 w-full flex justify-around mt-4">
                        ...
                        <button type="submit" class="text-white-500 bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">登録する
                        </button>                        
                      </div>
                    </div>
                  </form>
