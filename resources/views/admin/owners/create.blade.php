                      ...
                      <div class="-m-2">
                        <div class="p-2 w-1/2 mx-auto">
                          <div class="relative">
                            ...
                            <input type="text" id="name" required name="name" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                          </div>
                        </div>
                        <div class="p-2 w-1/2 mx-auto">
                          <div class="relative">
                        ...
                        <div class="flex justify-around p-2 w-full mt-12 mb-12">
                          <button onclick="location.href='{{ route("admin.owners.index")}}'" class="text-white-500 bg-blue-600 border-0 py-2 px-12 focus:outline-none hover:bg-indigo-600 rounded text-lg">戻る</button>
                          <button class="text-white-500 bg-blue-600 border-0 py-2 px-12 focus:outline-none hover:bg-indigo-600 rounded text-lg">登録する</button>
                        </div>
                      </div>
                    </div>
                  </div>
