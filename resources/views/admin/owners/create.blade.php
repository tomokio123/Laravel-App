                    ...
                    <form method="post" action="{{ route("admin.owners.store") }}">
                      ...
                      <div class="-m-2">
                        ...
                        <div class="flex justify-around p-2 w-full mt-12 mb-12">
                          <button type="button" onclick="location.href='{{ route("admin.owners.index")}}'" class="text-white-500 bg-blue-600 border-0 py-2 px-12 focus:outline-none hover:bg-indigo-600 rounded text-lg">戻る</button>
                          <button type="submit" class="text-white-500 bg-blue-600 border-0 py-2 px-12 focus:outline-none hover:bg-indigo-600 rounded text-lg">登録する</button>
                        </div>
                      </div>
                    </form>
                    </div>
